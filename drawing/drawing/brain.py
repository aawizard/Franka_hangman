...
class Brain(Node):
    ...
    def create_manual_point(self, letter, idx):
        ...
        via_points_A = [(0.01, 0.01), (30, 70), (60, 0),
                        (45, 35), (15, 35), (0, 0)]
        via_points_B = [(10, 0), (10, 70), (20, 70), (50, 47),
                        (20, 35), (50, 23), (20, 0), (10, 0), (0, 0)]
        via_points_C = [(50, 60), (30, 70), (10, 35),
                        (30, 0), (50, 10), (0, 0)]
        via_points_D = [(10, 0), (10, 70), (20, 70),
                        (50, 47), (50, 23), (20, 0), (10, 0), (0, 0)]
        via_points_E = [(50, 70), (10, 70), (10, 35),
                        (30, 35), (10, 35), (10, 0), (50, 0), (0, 0)]
        via_points_F = [(50, 70), (10, 70), (10, 35),
                        (30, 35), (10, 35), (10, 0), (0, 0)]
        via_points_G = [(50, 60), (30, 70), (10, 35), (30, 0),
                        (50, 10), (50, 25), (35, 25), (0, 0)]
        via_points_H = [(10, 70), (10, 0), (10, 35),
                        (50, 35), (50, 70), (50, 0), (0, 0)]
        via_points_I = [(30, 70), (30, 0), (0, 0)]
        via_points_J = [(10, 20), (30, 0), (50, 20), (50, 70), (0, 0)]
        via_points_K = [(10, 70), (10, 0), (10, 35),
                        (50, 70), (10, 35), (50, 0), (0, 0)]
        via_points_L = [(10, 70), (10, 0), (50, 0), (0, 0)]
        via_points_M = [(10, 0), (10, 70), (30, 35), (50, 70), (50, 0), (0, 0)]
        via_points_N = [(10, 0), (10, 70), (50, 0), (50, 70), (0, 0)]
        via_points_O = [(50, 20), (30, 0), (10, 20), (10, 50),
                        (30, 70), (50, 50), (50, 20), (0, 0)]
        via_points_P = [(10, 0), (10, 70), (30, 70),
                        (50, 50), (30, 35), (10, 35), (0, 0)]
        via_points_Q = [(50, 20), (30, 0), (10, 20), (10, 50),
                        (30, 70), (50, 50), (50, 20), (60, 0), (0, 0)]
        via_points_R = [(10, 0), (10, 70), (30, 70), (50, 50),
                        (30, 35), (10, 35), (50, 0), (0, 0)]
        via_points_S = [(50, 70), (10, 70), (10, 35),
                        (50, 35), (50, 0), (10, 0), (0, 0)]
        via_points_T = [(50, 70), (10, 70), (30, 70), (30, 0), (0, 0)]
        via_points_U = [(10, 70), (10, 20), (30, 0),
                        (50, 20), (50, 70), (0, 0)]
        via_points_V = [(10, 70), (30, 0), (50, 70), (0, 0)]
        via_points_W = [(10, 70), (20, 0), (30, 35), (40, 0), (50, 70), (0, 0)]
        via_points_X = [(10, 70), (50, 0), (30, 35), (50, 70), (10, 0), (0, 0)]
        via_points_Y = [(10, 70), (30, 35), (50, 70), (10, 0), (0, 0)]
        via_points_Z = [(10, 70), (50, 70), (10, 0), (50, 0), (0, 0)]
